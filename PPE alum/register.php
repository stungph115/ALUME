                    ...
                    <div class="register-form">
                        ...
                        <form method="POST" action ="">
                         <table border =0>       
                            ...
                            <tr><div class="group-input">
                                    <label for="con-pass">Votre nom </label>
                                    <input type="text" name="NOM">
                                </div>
                            </tr>

                            <tr><div class="group-input">
                                    <label for="con-pass">Votre numéro de téléphone </label>
                                     <input type="text" name="TEL">
                                </div>
                            </tr>
                            <button type="submit" value="submit" name="submit" class="site-btn register-btn">S'INSCRIRE</button>
                        </table>        
                        </form>
                        <?php
                        ...
                        <div class="switch-login">
                            <a href="login.php" class="or-login">Vous ête déjà client ?</a>
                        </div>
                    </div>
                </div>
            </div>
