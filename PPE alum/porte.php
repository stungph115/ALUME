                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="img/produit/porte/porte-dentree-ariane-aluminium-bois.jpg" alt="">
                                        <ul>
                                            <li class="w-icon active"><a href="#"><i class="icon_bag_alt"></i></a></li>
                                        </ul>
                                    </div>
                                    <div class="pi-text">
                                        <div class="catagory-name">Porte d'entrée</div>
                                        <a href="#">
                                            <h5>Porte d'entrée Ariane</h5>
                                        </a>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="img/produit/porte/porte-dentree-clairac-aluminium.jpg" alt="">
                                        <ul>
                                            <li class="w-icon active"><a href="#"><i class="icon_bag_alt"></i></a></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="img/produit/porte/porte-dentree-muse-aluminium.jpg" alt="">
                                        <ul>
                                            <li class="w-icon active"><a href="#"><i class="icon_bag_alt"></i></a></li>
                                        </ul>
                                    </div>
