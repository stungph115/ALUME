            ...
            <form action="#" class="checkout-form">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <h4>Vous n'êtes pas encore client chez nous?</h4>
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="create-item">
                                    <label for="acc-create">
                                        ...
                                        <button type="submit" value="submit" name="submit" class="site-btn register-btn"> Créer un compte</button>
                                    </label>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    <li class="fw-normal">Fenêtre rond x 1 <span>369,00 €</span></li>
