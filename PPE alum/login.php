                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="login-form">
                        ...
                        <form method="post" action="membre.php">
                            ...
                            <button type='submit' name='connexion' value='connexion' class="site-btn login-btn">Connecter</button>
                        </form>
                        <?php
                            ...
                            connexion();
                             ...
                             $srequeteql = 'SELECT count(*) FROM membre WHERE EMAIL="'.mysql_escape_string($_POST['EMAIL']).'" AND MDP="'.mysql_escape_string(($_POST['MDP'])).'"';
                        ...
                        <div class="switch-login">
                            <a href="register.php" class="or-login">Ou  inscrivez-vous</a>
                        </div>
                    </div>
                </div>
            </div>
